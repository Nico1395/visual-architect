...
public static class AddDesignProject
{
    ...
    private sealed class AddDesignProjectCommandHandler(
        ...
        IMediator _mediator) : ICommandHandler<AddDesignProjectCommand>
    {
        public async Task<ICommandResponse> HandleAsync(AddDesignProjectCommand request, CancellationToken cancellationToken)
        {
